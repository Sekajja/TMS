...
<link rel="stylesheet" type="text/css"
	href="<c:url value='/resources/css/decorator_register.css'/>" />

</head>
<body
	background="<c:url value='/resources/images/background/dotCircleRed.png'/>">

	<header>
	<div>
		<div style="float: left; width: 70px; overflow: hidden;">
			<img src="<c:url value='/resources/images/logo/Calendar.png'/>"
				alt="logo" height="70" width="70" />
		</div>

		<div style="float: left; overflow: hidden; padding-left: 70px;">
			<nav style="line-height: 70px"> <label>Plan</label> . <label>Project</label>
			. <label>Prosper</label> </nav>
		</div>
	...
	<form action="${postLoginUrl}" method="post">
		<font
			style="color: #333333; font-family: Century Gothic, Charcoal, sans-serif, Sawasdee; -webkit-font-smoothing: antialiased;">
			...
			<table align="center" class="formbox" style="padding: 20px;">
				...
				<tr>
					<td></td>
					<td><font
						style="color: #333333; font-family: Century Gothic, Charcoal, sans-serif, Sawasdee; -webkit-font-smoothing: antialiased; font-size: 80%;">
			...
			<div align="center">
				<c:if test="${param.failed == true}">
					<div class="error" align="center">Your login attempt failed.
	...
	<footer> <%-- <div class="welcomefooter">
	...
	<div class="loginlastfooter">Copyright &copy; 2015. IICS Project,
